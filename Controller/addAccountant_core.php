...
if ('addAccountant' == $action) {
    ...
    if ($password == $con_password) {
        ...
        if ($name && $dob && $address && $phone_no && $email && $password) {
            ...
            $query = "INSERT INTO users (name, dob, gender, address, email, phone_no, password, user_type) VALUES ('$name', '$dob', '$gender', '$address', '$email', '$phone_no', '$has_password', 'accountant')";
